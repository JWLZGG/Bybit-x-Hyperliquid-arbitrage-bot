...
### Core exchange and market infrastructure
...
- meaningful automated test suite runnable in Docker
...
Final testing on the initial major-pair universe — BTCUSDT, ETHUSDT and SOLUSDT — did not demonstrate sufficient observed gross edge to overcome realistic all-in costs between Bybit and Hyperliquid in the tested market regime.
...
- paper-trading flow
- reconciliation and realized PnL
